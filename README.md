...
4Z API以让AI普惠大众为使命，力争成为市面上性价比最高，最稳定的企业级中转API。4Z API的定价策略简单明了，按照OpenAI官方价格转换人民币1:1倍率计费，即，0.89元可购买1美金Token，所有模型对标官网统一定价。白菜GPT模型价格远低于官方价格，请珍惜🎁分享🌟转发💎好友。OpenAI官方每个模型的具体价格可参考其官网（[https://openai.com/api/pricing/](https://openai.com/api/pricing/)）。
